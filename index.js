...
function createMenuItem(name, cost, category) {
  const hotDog = { name: name, prices: cost, category: category };
  return hotDog;
}
...
// console.log(createMenuItem("Burrito Bowl", 8, "Lunch/Dinner"));
...
const burger2 = {
  ...
  price: 18,
  category: "Lunch",
  discountOf: function (typeOfCustomer) {
    if (typeOfCustomer === "teacher") {
      let priceWithTDiscount = burger2.price * 0.25;
      return (
        "Since you are a teacher the discounted price of this item is ",
        burger2.price - priceWithTDiscount
      );
    } else {
      let priceWithRDiscount = burger2.price * 0.1;
      return (
        "Today we have a special running and the dis counted price of your item is ",
        burger2.price - priceWithRDiscount
      );
    }
  },
};

// console.log(burger2.discountOf("student"));
...
const newReview = {
  ...
  rating: 5,
  feedback:
    "This restaurnat was amazing, my wfie and I come here to eat every month.",
};
 ...
 * it will return `Daniela gave the restaurant a 5 star review and their feedback was: Beautiful atmosphere and 
